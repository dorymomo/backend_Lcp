	...
	<div class="l-main">
		<div class="l-container">
			<div class="p-password-find">
				<form action="${pageContext.request.contextPath}/user/pwFind.usr" method="post">
					<div class="l-password-find-layout">
						...
						<div class="c-password-find-input">
							<h6>아이디</h6>
							<input type="text" name="userId" id="find-user-id" class="c-input"
								placeholder="아이디 입력해주세요" />
							<p id="is-find-user-id-error" class="is-error-text"></p>
						</div>
						<div class="c-password-find-input">
							<h6>이름</h6>
							<input type="text" name="userName" id="find-user-name" class="c-input"
								placeholder="이름 입력해주세요" />
							<p id="is-find-user-name-error" class="is-error-text"></p>
						</div>
						<div class="c-password-find-input">
							<h6>생년월일</h6>
							<input type="text" name="userBirth" id="find-user-birth" class="c-input"
								placeholder="생년월일 입력해주세요" />
							<p id="is-find-user-birth-error" class="is-error-text"></p>
						</div>
						<div class="c-password-find-input">
							<h6>이메일</h6>
							<input type="text" name="userEmail" id="find-user-email" class="c-input"
